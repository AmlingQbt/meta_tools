    ...
    public int run(final OptionsResults<? extends Options> options) throws Exception {
        ...
        class Naive {
            public CommitData.Builder inline(CommitData.Builder cd) {
                ...
                newTree = newTree.replace("qbt-manifest", QbtUtils.linesToBytes(config.manifestParser.deparse(newManifest.build())));
            ...
            public CommitData.Builder extract(CommitData.Builder cd, boolean addPins) {
                ...
                newTree = newTree.replace("qbt-manifest", QbtUtils.linesToBytes(config.manifestParser.deparse(newManifestBuilt)));
                cd = cd.set(CommitData.TREE, newTree.getDigest());
